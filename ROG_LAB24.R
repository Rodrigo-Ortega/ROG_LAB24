...
genes <- as.matrix(
  read.csv( "C:\\Users\\turismo\\Dropbox\\DCEA\\4to. Semestre\\Ciencia de datos\\Documentos para laboratorios\\LAB24\\heatmap_data.csv",
            sep = "," ,
            header = T,
            row.names = 1))

annotation_col <- read.csv( "C:\\Users\\turismo\\Dropbox\\DCEA\\4to. Semestre\\Ciencia de datos\\Documentos para laboratorios\\LAB24\\annotation_col.csv", header = T,
            row.names = 1)

annotation_row <- read.csv( "C:\\Users\\turismo\\Dropbox\\DCEA\\4to. Semestre\\Ciencia de datos\\Documentos para laboratorios\\LAB24\\annotation_row.csv", header = T,
                            row.names = 1)
...
pheatmap(sub, frontsize = 6, cluster_rows = T, cluster_cols = T, annotation_row = annotation_row, 
         ...
         fontsize_number = 6, col=viridis_pal(option = "inferno") (6))
